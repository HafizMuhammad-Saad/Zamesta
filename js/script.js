const allProducts = [
  {
    ...
    price: 99.99,
    image_url:
      "https://images.unsplash.com/photo-1629738601425-494c3d6ba3e2?q=80&w=1742&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  },
  {
    ...
    price: 93.0,
    image_url:
      "https://cdn.pixabay.com/photo/2013/11/22/19/43/saffron-215932_1280.jpg",
  ...
  },
  {
    ...
    price: 100.0,
    image_url:
      "https://images.pexels.com/photos/3993529/pexels-photo-3993529.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    description: "This is a new product.",
    rating: 4,
    category: "dates",
    inStoke: true,
  },
  {
    ...
    price: 999.99,
    image_url:
      "https://images.pexels.com/photos/302163/pexels-photo-302163.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    description: "This is a new product.",
    rating: 2.5,
    category: "honey",
    inStoke: true,
        ...
        <img src="${product.image_url}" alt="${product.name}" class="w-full h-64 object-cover">
            ...
            <div class="p-6">
                ...
                <div class="flex justify-center space-x-3 " >
                    <button  class="add-to-cart p-2 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors"
                    onClick="addToCart('${product.name}','${product.id}','${product.price}','${product.image_url}','${activeUser.userId}')">
...
// my work add to cart function




const addToCart = async (name, productId,price ,url,userId) => {
  console.log(name,price,productId,url,userId);
 
  // check before adding data, cart table;
      try {
    ...
    if(cartData) {
      ...
      // if cart data length is 0 then add
